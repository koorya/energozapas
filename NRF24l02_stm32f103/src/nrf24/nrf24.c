...
#define NRF24_CSN_HIGH()        NRF24_CSN_Port->ODR |=  NRF24_CSN_Pin
#define NRF24_CSN_LOW()         NRF24_CSN_Port->ODR &= ~ NRF24_CSN_Pin
#define NRF24_CE_HIGH()         NRF24_CE_Port->ODR |=  NRF24_CE_Pin
#define NRF24_CE_LOW()          NRF24_CE_Port->ODR &= ~ NRF24_CE_Pin
